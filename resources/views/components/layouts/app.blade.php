...
<body class="flex min-h-[100vh] flex-col bg-black text-white">
    <header
        class="max-w-lg:px-4 max-w-lg:mr-auto absolute top-0 z-20 flex h-[60px] w-full bg-opacity-0 px-[5%] lg:justify-around">
        ...
        <div class="collapsible-header animated-collapse max-lg:shadow-md" id="collapsed-header-items">
            ...
            <div
                ...
                <a href="" aria-label="signup"
                    class="rounded-full bg-white px-3 py-2 text-black transition-transform duration-[0.3s] hover:translate-x-2">
                    <span>Get started</span>
                    <i class="bi bi-arrow-right"></i>
                </a>
            </div>
        </div>
        <button class="bi bi-list absolute right-3 top-3 z-50 text-3xl text-white lg:hidden" onclick="toggleHeader()"
            aria-label="menu" id="collapse-btn"></button>
    </header>
    <main>
        {{ $slot }}
    </main>
...
<script src="./index.js"></script>Internal Server Error
